 ...
 * 클래스 변수(정적 변수), 클래스 메서드(정적 메서드)는 static을 선언한 클래스의 멤버를 말하며,
...
namespace Ch05
{
    class Increment
    {
        public int num1;  //int의 기본값은 0 (생략해도 됨)
        ...
        {
            // static 메서드(클래스 메서드)에서는 non-static 변수를 참조할 수 없다.(문법)
            //num1++;
            num2++;
    ...
    internal class _3_Static
    {
        static void Main3(string[] args)
        {
            ...
            //Calc 싱글톤 객체 가져오기
            Calc c1 = Calc.Instance;  //객체가 5개가 아니라 결국 모여서 하나인 것
