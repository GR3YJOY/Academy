...
namespace Ch02
{
    internal class _2_DataType
    {
        ...
        {
            // 정수형
            sbyte num1 = 127;         //1byte, 부호 있는 정수, -126 - 127
            byte  num2 = 255;         //1byte, 부호 없는 정수, 0 - 255  
            short num3 = 32767;       //2byte, 부호 없는 정수, -32,766 - 32,767
            ...
            Console.WriteLine("num : {0}", num3);
            Console.WriteLine("num : {0}", num4);
            Console.WriteLine("num : {0}", num5);

            // 실수형
            float var1 = 1.123456789f;
            double var2 = 1.1234567891234567890;
